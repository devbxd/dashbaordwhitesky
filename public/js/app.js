...
<div class="header-actions">
  ...
  <button class="btn-secondary" onclick="printQuote('print')"><i class="ti ti-printer"></i> Print / PDF</button>
</div></div>
...
<div class="header-actions"><button class="btn-secondary" onclick="showPage('credit-notes')"><i class="ti ti-arrow-left"></i> Back</button><button class="btn-secondary" onclick="printCreditNote('print')"><i class="ti ti-printer"></i> Print / PDF</button></div></div>
<div id="printable"><div class="inv-wrap card">
  <div class="inv-head">
    <div class="inv-head-left"><div style="display:flex;flex-direction:column;align-items:flex-start;gap:8px">${logoHtml}<div class="inv-company-name">${s.company_name||''}</div></div></div>
